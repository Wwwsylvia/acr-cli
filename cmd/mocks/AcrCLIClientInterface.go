...
func (_m *AcrCLIClientInterface) GetAcrTags(ctx context.Context, repoName string, orderBy string, last string) (*acr.RepositoryTagsType, string, error) {
	ret := _m.Called(ctx, repoName, orderBy, last)
	...
	if rf, ok := ret.Get(2).(func(context.Context, string, string, string) error); ok {
		r2 = rf(ctx, repoName, orderBy, last)
	} else {
		r2 = ret.Error(2)
	}
